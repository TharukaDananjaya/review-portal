        ...
        <div class="w-full max-w-md mt-8">
            <div class="card dark:bg-slate-800 p-8 rounded-xl shadow-md">
                ...
                <form method="POST" action="{{ route('login') }}" class="mt-8">
                    @csrf
                    <div class="mb-4">
                        <label for="email" class="block text-sm dark:text-white text-gray-500 mb-2">Email <span
                    ...
                    <div class="mb-4">
                        <label for="password" class="block text-sm dark:text-white text-gray-500 mb-2">Password <span
                                class="text-red-500"><strong>*</strong></span></label>
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center">
                            ...
                            <label for="checkbox" class="ml-2 block text-sm dark:text-white text-gray-500">Remember
                                Me</label>
                        </div>
                    ...
                    <div class="flex items-end justify-end">
                        <button type="submit"
                            class="background-accent-light-custom hover:bg-blue-400 w-full h-10 text-sm dark:text-white text-gray-300 py-2 px-4 rounded-lg focus:outline-none">Sign
                            in</button>
                    </div>
                </form>
                ...
                @if (Route::has('register'))
                    <div class="mt-4 text-center">
                        <a href="{{ route('register') }}" class="text-sm dark:text-white text-gray-500">Don't have an
                            account?
