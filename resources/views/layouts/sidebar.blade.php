        ...
        <ul class="space-y-2 font-medium mt-3">
            <li>
                <a href="{{ route('dashboard') }}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white   group {{ Request::routeIs('dashboard') ? 'active hover:bg-blue-400' : 'hover:bg-gray-100 dark:hover:bg-slate-700' }}">
                    ...
                    <ul id="dropdown-users"
                        ...
                        <li>
                            <a href="{{ route('admin.users.add') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group  dark:text-white  {{ Request::routeIs('admin.users.add') ? 'active hover:bg-blue-400' : 'hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                        ...
                        <li>
                            <a href="{{ route('admin.users.manage') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group  dark:text-white  {{ Request::routeIs('admin.users.manage') ? 'active hover:bg-blue-400' : 'hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor"
            ...
            <li>
                <a href="@if (auth()->user()->type == 1) {{ route('admin.profile') }} @else {{ route('user.profile') }} @endif"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white   group {{ Request::routeIs('profile') ? 'active hover:bg-blue-400' : 'hover:bg-gray-100 dark:hover:bg-slate-700' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor"
