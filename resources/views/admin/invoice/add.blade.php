...
@section('content')
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2 bg-white dark:bg-slate-700 p-2 text-sm rounded-md shadow-md">
            ...
            <li>
                <span class="color-light-custom">Create Invoice</span>
            </li>
        </ol>
    </nav>
    {{-- end breadcrumb --}}
    ...
    <div class="mt-5">
        <div class="">
            <div class="shadow-md p-3 rounded-md">
                <form method="POST" action="{{ route('admin.invoice.store') }}" class="mt-8">
                    @csrf
                        ...
                        <div>
                            <div class="mb-4">
                                ...
                                <select id="product_condition" name="product_condition"
                                    ...
                                    <option value="DESCELLER">DESCELLER</option>
                                    <option value="VENANT">VENANT</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-5 gap-4 mt-2 mb-4">
                        ...
                        <div class="text-center">
                            <h1 id="grand_total" class="text-2xl text-gray-900 dark:text-white">0.00</h1>
                        </div>
                    </div>
