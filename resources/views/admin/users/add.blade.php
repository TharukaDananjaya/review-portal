                ...
                <form method="POST" action="{{ route('admin.users.store') }}" class="mt-8">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <div class="mb-4">
                                <label for="name"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name <span class="text-red-500"><strong>*</strong></span></label>
                            ...
                            <div class="mb-4">
                                <label for="mobile_number"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mobile Number <span class="text-red-500"><strong>*</strong></span></label>
                            ...
                            <div class="mb-4">
                                <label for="email"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email <span class="text-red-500"><strong>*</strong></span></label>
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                <label for="password"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password <span class="text-red-500"><strong>*</strong></span></label>
