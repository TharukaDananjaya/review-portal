...
@section('content')
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2 bg-white dark:bg-slate-700 p-2 text-sm rounded-md shadow-md">
            ...
            <li>
                <span class="color-light-custom">Edit User</span>
            </li>
        </ol>
    </nav>
    {{-- end breadcrumb --}}
    ...
    <div class="mt-5">
        <div class="grid sm:grid-cols-5 grid-cols-1">
            <div class="sm:col-start-2 sm:col-span-3 shadow-md p-3 rounded-md">
                <form method="POST" action="{{ route('admin.users.update') }}" class="mt-8">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="mb-4">
                                <label for="mobile_number"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mobile Number <span
                                        class="text-red-500"><strong>*</strong></span></label>
                        ...
                        <div>
                            ...
                            {{-- <div class="flex items-center">
                                ...
                                <label for="checkbox" class="ml-2 ext-sm font-medium text-gray-900 dark:text-white">Invite via email</label>
                            </div> --}}
                        </div>
                    </div>
