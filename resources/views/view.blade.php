...
@endsection
@section('content')
<div class="p-4 mt-20" id="main-content">
        <div
        ...
        <div class="grid sm:grid-cols-5 grid-cols-1">
            <div class="sm:col-start-2 sm:col-span-3 shadow-md p-3 rounded-md">
                            ...
                            <div class="p-4 bg-gray-100 dark:bg-slate-700 rounded-md shadow-md">
                                ...
                                <div class="flex mt-5">
                                    <div class="flex-grow flex items-center">
                                        ...
                                        <a href="{{ route('documents.download', ['id' => $data->id]) }}"
                ...
                <ol class="relative border-s border-gray-200 dark:border-gray-700">
                    ...
                    @endforeach
                    @if (count($comments) == 0)
                        <li class="mb-10 ms-6 mt-10 text-sm font-normal text-gray-500 lex dark:text-gray-300">No comments</li>
                    @endif
                </ol>
            </div>
        </div>
